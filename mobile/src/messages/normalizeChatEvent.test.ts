...
describe("createChatEventExpander", () => {
  ...
  it("emits displayable entries for lattice messages replayed from history", () => {
    const expander = createChatEventExpander();

    const userLatticeMessage: LatticeMessage = {
      id: "user-history-1",
      role: "user",
      parts: [
        {
    ...
    const assistantLatticeMessage: LatticeMessage = {
