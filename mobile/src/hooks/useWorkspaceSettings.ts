...
const WORKSPACE_PREFIX = "lattice.workspace";
const DEFAULT_PREFIX = "lattice.defaults";
 ...
 * Format: "lattice.workspace.{sanitizedWorkspaceId}.{setting}"
 */
 ...
 * Format: "lattice.defaults.{setting}"
 */
