...
const shouldRunPerfScenarios = process.env.LATTICE_E2E_RUN_PERF === "1";
const selectedProfiles = parseHistoryProfilesFromEnv(process.env.LATTICE_E2E_PERF_PROFILES);
...
test.describe("workspace open performance profiling", () => {
  test.skip(!shouldRunPerfScenarios, "Set LATTICE_E2E_RUN_PERF=1 to run perf profiling scenarios");
