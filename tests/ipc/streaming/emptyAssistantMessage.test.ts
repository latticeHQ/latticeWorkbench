  ...
  test.concurrent(
    ...
    async () => {
      ...
      try {
        ...
        const messages = [
          createLatticeMessage("msg-1", "user", "Hello", {}),
          createLatticeMessage("msg-2", "assistant", "Hi there!", {}),
          createLatticeMessage("msg-3", "user", "Follow up question", {}),
  ...
  test.concurrent(
    ...
    async () => {
      ...
      try {
        ...
        const messages = [
          createLatticeMessage("msg-1", "user", "Run a command", {}),
