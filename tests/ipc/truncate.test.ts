  ...
  test.concurrent(
    ...
    async () => {
      ...
      try {
        ...
        const messages = [
          createLatticeMessage("msg-1", "user", `Remember this word: ${uniqueWord}`, {}),
          createLatticeMessage("msg-2", "assistant", "I will remember that word.", {}),
          createLatticeMessage("msg-3", "user", "What is 2+2?", {}),
          createLatticeMessage("msg-4", "assistant", "4", {}),
          createLatticeMessage("msg-5", "user", "What is 3+3?", {}),
          createLatticeMessage("msg-6", "assistant", "6", {}),
        ];
    ...
    async () => {
      ...
      try {
        ...
        const messages = [
          createLatticeMessage("msg-1", "user", `Remember this word: ${uniqueWord}`, {}),
          createLatticeMessage("msg-2", "assistant", "I will remember that word.", {}),
          createLatticeMessage("msg-3", "user", "Tell me a fact about cats", {}),
          createLatticeMessage("msg-4", "assistant", "Cats sleep 12-16 hours a day.", {}),
        ];
