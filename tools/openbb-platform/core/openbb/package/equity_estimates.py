        ...
        symbol: Annotated[
            ...
            OpenBBField(
                description=(
                    ...
                    'items allowed for provider(s): fmp, intrinio, tmx,'
                    'yfinance.'
                )
            )
        ] = None,
...
>>> obb.equity.estimates.forward_ebitda(symbol='AAPL,MSFT', fiscal_period='quarter')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'fmp': {'multiple_items_allowed': True, 'choices': None}, 'intrinio': {'multiple_items_allowed': True, 'choices': None}}, 'fiscal_period': {'fmp': {'choices': ['annual', 'quarter']}, 'intrinio': {'choices': ['quarter', 'annual']}}, 'estimate_type': {'intrinio': {'choices': ['ebitda', 'ebit', 'enterprise_value', 'cash_flow_per_share', 'pretax_income']}}},
            )
        )
        ...
        provider: Annotated[
            ...
            OpenBBField(
                description=(
                    'The provider to use, by default None. If None, the'
                    'priority list configured in the settings is used.'
                    'Default priority: fmp, intrinio, seeking_alpha.'
                )
            )
        ] = None,
        **kwargs
...
period : str
    ...
    Choices for seeking_alpha: 'annual', 'quarter'
...
>>> obb.equity.estimates.forward_eps(fiscal_year=2025, fiscal_period='fy')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'fmp': {'multiple_items_allowed': True, 'choices': None}, 'intrinio': {'multiple_items_allowed': True, 'choices': None}, 'seeking_alpha': {'multiple_items_allowed': True, 'choices': None}}, 'fiscal_period': {'fmp': {'choices': ['annual', 'quarter']}, 'intrinio': {'choices': ['fy', 'q1', 'q2', 'q3', 'q4']}}, 'calendar_period': {'intrinio': {'choices': ['q1', 'q2', 'q3', 'q4']}}, 'period': {'seeking_alpha': {'choices': ['annual', 'quarter']}}},
            )
        )
        ...
        provider: Annotated[
            ...
            OpenBBField(
                description=(
                    'The provider to use, by default None. If None, the'
                    'priority list configured in the settings is used.'
                    'Default priority: intrinio, seeking_alpha.'
                )
            )
        ] = None,
        **kwargs
...
>>> obb.equity.estimates.forward_sales(fiscal_year=2025, fiscal_period='fy')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'intrinio': {'multiple_items_allowed': True, 'choices': None}, 'seeking_alpha': {'multiple_items_allowed': True, 'choices': None}}, 'fiscal_period': {'intrinio': {'choices': ['fy', 'q1', 'q2', 'q3', 'q4']}}, 'calendar_period': {'intrinio': {'choices': ['q1', 'q2', 'q3', 'q4']}}, 'period': {'seeking_alpha': {'choices': ['annual', 'quarter']}}},
            )
        )
...
>>> obb.equity.estimates.historical(symbol='AAPL')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'fmp': {'multiple_items_allowed': True, 'choices': None}}, 'period': {'fmp': {'choices': ['quarter', 'annual']}}},
            )
        )
    ...
    def price_target(
        ...
        symbol: Annotated[
            ...
            OpenBBField(
                description=(
                    'Symbol to get data for. Multiple comma separated'
                    'items allowed for provider(s): benzinga, finviz,'
                    'fmp.'
                )
            )
        ] = None,
        ...
        provider: Annotated[
            ...
            OpenBBField(
                description=(
                    'The provider to use, by default None. If None, the'
                    'priority list configured in the settings is used.'
                    'Default priority: benzinga, finviz, fmp.'
                )
            )
        ] = None,
        **kwargs
