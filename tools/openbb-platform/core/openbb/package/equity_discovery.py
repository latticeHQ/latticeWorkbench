...
>>> obb.equity.discovery.gainers(sort='desc')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'category': {'tmx': {'multiple_items_allowed': False, 'choices': ['dividend', 'energy', 'healthcare', 'industrials', 'price_performer', 'rising_stars', 'real_estate', 'tech', 'utilities', '52w_high', 'volume']}}},
            )
        )
