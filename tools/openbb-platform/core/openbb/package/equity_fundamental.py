...
period : str
    Time period of the data to return. (provider: fmp,intrinio, yfinance)
...
inventory : int | None
    Inventory. (provider: fmp)
other_current_assets : float | int | None
    Other current assets. (provider: fmp, intrinio)
total_current_assets : float | int | None
    Total current assets. (provider: fmp, intrinio)
...
intangible_assets : float | int | None
    Intangible assets. (provider: fmp, intrinio)
...
other_non_current_assets : int | None
    Other non current assets. (provider: fmp)
...
total_assets : float | int | None
    Total assets. (provider: fmp, intrinio)
accounts_payable : float | int | None
    Accounts payable. (provider: fmp, intrinio)
prepaid_expenses : float | int | None
    Prepaid expenses. (provider: fmp, intrinio)
...
other_non_current_liabilities : int | None
    Other non current liabilities. (provider: fmp)
total_non_current_liabilities : float | int | None
    Total non current liabilities. (provider: fmp, intrinio)
...
total_liabilities : float | int | None
    Total liabilities. (provider: fmp, intrinio)
preferred_stock : float | int | None
    Preferred stock. (provider: fmp, intrinio)
...
minority_interest : int | None
    Minority interest. (provider: fmp)
...
accounts_receivable : float | None
    Accounts receivable. (provider: intrinio)
...
redeemable_non_controlling_interest : float | None
    Redeemable non-controlling interest. (provider: intrinio)
...
>>> obb.equity.fundamental.balance(symbol='AAPL', period='annual', limit=5)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'period': {'fmp': {'choices': ['q1', 'q2', 'q3', 'q4', 'fy', 'ttm', 'annual', 'quarter']}, 'intrinio': {'multiple_items_allowed': False, 'choices': ['annual', 'quarter']}, 'yfinance': {'multiple_items_allowed': False, 'choices': ['annual', 'quarter']}}},
            )
        )
...
>>> obb.equity.fundamental.balance_growth(symbol='AAPL', limit=10)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'period': {'fmp': {'choices': ['q1', 'q2', 'q3', 'q4', 'fy', 'annual', 'quarter']}}},
            )
        )
...
>>> obb.equity.fundamental.cash(symbol='AAPL', period='annual', limit=5)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'period': {'fmp': {'choices': ['q1', 'q2', 'q3', 'q4', 'fy', 'ttm', 'annual', 'quarter']}, 'intrinio': {'multiple_items_allowed': False, 'choices': ['annual', 'quarter', 'ttm', 'ytd']}, 'yfinance': {'multiple_items_allowed': False, 'choices': ['annual', 'quarter']}}},
            )
        )
        ...
        symbol: Annotated[
            ...
            OpenBBField(
                description=(
                    ...
                    'items allowed for provider(s): fmp, nasdaq.'
                )
            )
        ],
        ...
        provider: Annotated[
            ...
            OpenBBField(
                description=(
                    'The provider to use, by default None. If None, the'
                    'priority list configured in the settings is used.'
                    'Default priority: fmp, intrinio, nasdaq, tmx,'
                    'yfinance.'
                )
            )
        ] = None,
...
symbol : str | list[str]
    Symbol to get data for. Multiple comma separated items allowed for provider(s): fmp, nasdaq.
...
>>> obb.equity.fundamental.dividends(symbol='AAPL')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'fmp': {'multiple_items_allowed': True, 'choices': None}, 'nasdaq': {'multiple_items_allowed': True, 'choices': None}}},
            )
        )
        ...
        provider: Annotated[
            ...
            OpenBBField(
                description=(
                    'The provider to use, by default None. If None, the'
                    'priority list configured in the settings is used.'
                    'Default priority: fmp, intrinio, nasdaq, sec, tmx.'
                )
            )
        ] = None,
        **kwargs
...
form_group : str
    ...
    Choices for nasdaq: 'annual', 'quarterly', 'proxy', 'insider', '8k', 'registration', 'comment'
use_cache : bool
    ...
    def historical_eps(
        ...
        symbol: Annotated[
            ...
            OpenBBField(
                description=(
                    'Symbol to get data for. Multiple comma separated'
                    'items allowed for provider(s): alpha_vantage, fmp.'
                )
            )
        ],
        provider: Annotated[
            ...
            OpenBBField(
                description=(
                    'The provider to use, by default None. If None, the'
                    'priority list configured in the settings is used.'
                    'Default priority: alpha_vantage, fmp.'
                )
            )
        ] = None,
        **kwargs
...
symbol : str | list[str]
    Symbol to get data for. Multiple comma separated items allowed for provider(s): alpha_vantage, fmp.
period : str
    Time period of the data to return. (provider: alpha_vantage)
    Choices for alpha_vantage: 'annual', 'quarter'
limit : int | None
...
report_time : str | None
    Time of day when the earnings report was released, e.g., 'post-market'. (provider: alpha_vantage)
...
>>> obb.equity.fundamental.historical_eps(symbol='AAPL')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'alpha_vantage': {'multiple_items_allowed': True, 'choices': None}, 'fmp': {'multiple_items_allowed': True, 'choices': None}}, 'period': {'alpha_vantage': {'choices': ['annual', 'quarter']}}},
            )
        )
...
income_tax_expense : float | int | None
    Income tax expense. (provider: fmp, intrinio)
...
diluted_earnings_per_share : float | None
    Diluted earnings per share. (provider: fmp, intrinio)
...
other_operating_expenses : float | None
    Other operating expenses (provider: intrinio)
depreciation_expense : float | None
    Depreciation expense (provider: intrinio)
amortization_expense : float | None
    Amortization expense (provider: intrinio)
...
include_tables : bool
    Return tables formatted as markdown in the text. Default is True. (provider: sec)
use_cache : bool
        ...
        provider: Annotated[
            ...
            OpenBBField(
                description=(
                    'The provider to use, by default None. If None, the'
                    'priority list configured in the settings is used.'
                    'Default priority: finviz, fmp, intrinio, yfinance.'
                )
            )
        ] = None,
        **kwargs
...
pe_ratio : float | None
    Price-to-earnings ratio (TTM). (provider: finviz,intrinio, yfinance)
forward_pe : float | None
    Forward price-to-earnings ratio (forward P/E) (provider: finviz, yfinance)
eps : float | None
...
return_on_assets : float | None
    Return on assets (ROA), as a normalized percent. (provider: finviz,fmp,intrinio, yfinance)
...
dividend_yield : float | None
    Dividend yield, as a normalized percent. (provider: finviz,intrinio, yfinance)
...
research_and_development_to_revenue : float | None
...
>>> obb.equity.fundamental.metrics(symbol='AAPL', period='annual', limit=100)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'finviz': {'multiple_items_allowed': True, 'choices': None}, 'fmp': {'multiple_items_allowed': True, 'choices': None}, 'intrinio': {'multiple_items_allowed': True, 'choices': None}, 'yfinance': {'multiple_items_allowed': True, 'choices': None}}, 'ttm': {'fmp': {'choices': ['include', 'exclude', 'only']}}, 'period': {'fmp': {'choices': ['q1', 'q2', 'q3', 'q4', 'fy', 'annual', 'quarter']}}},
            )
        )
...
>>> obb.equity.fundamental.ratios(symbol='AAPL', period='annual', limit=12)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'fmp': {'multiple_items_allowed': True, 'choices': None}}, 'ttm': {'fmp': {'choices': ['include', 'exclude', 'only']}}, 'period': {'fmp': {'choices': ['q1', 'q2', 'q3', 'q4', 'fy', 'annual', 'quarter']}, 'intrinio': {'multiple_items_allowed': False, 'choices': ['annual', 'quarter', 'ttm', 'ytd']}}},
            )
        )
        ...
        statement_type: Annotated[
            ...
            OpenBBField(
                description=(
                    ...
                    "intrinio) Choices for intrinio: 'balance',"
                    "'income', 'cash'"
                )
            )
        ] = 'balance',
...
>>> obb.equity.fundamental.reported_financials(symbol='AAPL', statement_type='cash')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'statement_type': {'intrinio': {'choices': ['balance', 'income', 'cash']}}},
            )
        )
...
>>> obb.equity.fundamental.revenue_per_geography(symbol='AAPL', period='quarter')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'period': {'fmp': {'choices': ['quarter', 'annual']}}},
            )
        )
