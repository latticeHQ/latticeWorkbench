...
class ROUTER_quantitative_rolling(Container):
    ...
    def kurtosis(
        ...
        data: Annotated[
            ...
            OpenBBField(
                description='The time series data as a list of data points.'
            )
        ],
        target: Annotated[
            str,
            OpenBBField(
                description=(
                    'The name of the column for which to calculate'
                    'kurtosis.'
                )
            )
        ],
        window: Annotated[
            ...
            OpenBBField(
                description=(
                    'The number of observations used for calculating'
                    'the rolling measure.'
                )
            )
        ] = 21,
        index: Annotated[
            str,
            OpenBBField(
                description='The name of the index column, default is "date".'
            )
        ] = 'date',
        **kwargs: Any
    ) -> OBBject:
...
>>> obb.quantitative.rolling.kurtosis(target='close', window=2, data='[{'date': '2023-01-02', 'close': 0.05}, {'date': '2023-01-03', 'close': 0.08}, {'date': '2023-01-04', 'close': 0.07}, {'date': '2023-01-05', 'close': 0.06}, {'date': '2023-01-06', 'close': 0.06}]')
    ...
    def mean(
        ...
        target: Annotated[
            ...
            OpenBBField(
                description=(
                    'The name of the column for which to calculate the'
                    'mean.'
                )
            )
        ],
...
>>> obb.quantitative.rolling.mean(target='close', window=2, data='[{'date': '2023-01-02', 'close': 0.05}, {'date': '2023-01-03', 'close': 0.08}, {'date': '2023-01-04', 'close': 0.07}, {'date': '2023-01-05', 'close': 0.06}, {'date': '2023-01-06', 'close': 0.06}]')
    ...
    def quantile(
        ...
        quantile_pct: Annotated[
            ...
            OpenBBField(
                description=(
                    'The quantile percentage to calculate (e.g., 0.5'
                    'for median), default is 0.5.'
                )
            )
        ] = 0.5,
        index: Annotated[
