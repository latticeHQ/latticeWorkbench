...
class ROUTER_news(Container):
    ...
    def company(
        ...
        provider: Annotated[
            Optional[Literal['benzinga', 'fmp', 'intrinio', 'tiingo', 'tmx', 'yfinance']],
            OpenBBField(
                description=(
...
----------
provider : str
    The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: benzinga, fmp, intrinio, tiingo, tmx, yfinance.
symbol : str | list[str | None] | None
    Symbol to get data for. Multiple comma separated items allowed for provider(s): benzinga, fmp, intrinio, tiingo, tmx, yfinance.
            ...
            **filter_inputs(
                provider_choices={
                    "provider": self._get_provider(
                        provider,
                        "news.company",
                        ('benzinga', 'fmp', 'intrinio', 'tiingo', 'tmx', 'yfinance'),
                    )
                },
                standard_params={
                    "symbol": symbol,
                ...
                extra_params=kwargs,
                info={'symbol': {'benzinga': {'multiple_items_allowed': True, 'choices': None}, 'fmp': {'multiple_items_allowed': True, 'choices': None}, 'intrinio': {'multiple_items_allowed': True, 'choices': None}, 'tiingo': {'multiple_items_allowed': True, 'choices': None}, 'tmx': {'multiple_items_allowed': True, 'choices': None}, 'yfinance': {'multiple_items_allowed': True, 'choices': None}}, 'display': {'benzinga': {'choices': ['headline', 'abstract', 'full']}}, 'sort': {'benzinga': {'choices': ['id', 'created', 'updated']}}, 'order': {'benzinga': {'choices': ['asc', 'desc']}}, 'source': {'intrinio': {'multiple_items_allowed': False, 'choices': ['yahoo', 'moody', 'moody_us_news', 'moody_us_press_releases']}, 'tiingo': {'multiple_items_allowed': True, 'choices': None}}, 'sentiment': {'intrinio': {'multiple_items_allowed': False, 'choices': ['positive', 'neutral', 'negative']}}},
            )
        )
        ...
        provider: Annotated[
            ...
            OpenBBField(
                description=(
                    'The provider to use, by default None. If None, the'
                    'priority list configured in the settings is used.'
                    'Default priority: benzinga, biztoc, fmp, intrinio,'
                    'tiingo.'
                )
            )
        ] = None,
...
>>> obb.news.world(term='apple')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'display': {'benzinga': {'choices': ['headline', 'abstract', 'full']}}, 'sort': {'benzinga': {'choices': ['id', 'created', 'updated']}}, 'order': {'benzinga': {'choices': ['asc', 'desc']}}, 'source': {'intrinio': {'choices': ['yahoo', 'moody', 'moody_us_news', 'moody_us_press_releases']}, 'tiingo': {'multiple_items_allowed': True, 'choices': None}}, 'topic': {'fmp': {'choices': ['fmp_articles', 'general', 'press_releases', 'stocks', 'forex', 'crypto']}}, 'sentiment': {'intrinio': {'choices': ['positive', 'neutral', 'negative']}}},
            )
        )
