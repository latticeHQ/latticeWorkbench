...
class ROUTER_quantitative_performance(Container):
    ...
    def omega_ratio(
        ...
        threshold_start: Annotated[
            float,
            OpenBBField(
                description='Start threshold, by default 0.0'
            )
        ] = 0.0,
        threshold_end: Annotated[
            float,
            OpenBBField(
                description='End threshold, by default 1.5'
            )
        ] = 1.5,
        **kwargs: Any
    ) -> OBBject:
...
>>> obb.quantitative.performance.omega_ratio(target='close', data='[{'date': '2023-01-02', 'close': 0.05}, {'date': '2023-01-03', 'close': 0.08}, {'date': '2023-01-04', 'close': 0.07}, {'date': '2023-01-05', 'close': 0.06}, {'date': '2023-01-06', 'close': 0.06}]')
    ...
    def sharpe_ratio(
        ...
        rfr: Annotated[
            float,
            OpenBBField(
                description='Risk-free rate, by default 0.0'
            )
        ] = 0.0,
        window: Annotated[
            int,
            OpenBBField(
                description='Window size, by default 252'
            )
        ] = 252,
        index: Annotated[
            str,
...
>>> obb.quantitative.performance.sharpe_ratio(target='close', window=2, data='[{'date': '2023-01-02', 'close': 0.05}, {'date': '2023-01-03', 'close': 0.08}, {'date': '2023-01-04', 'close': 0.07}, {'date': '2023-01-05', 'close': 0.06}, {'date': '2023-01-06', 'close': 0.06}]')
    ...
    def sortino_ratio(
        ...
        target_return: Annotated[
            float,
            OpenBBField(
                description='Target return, by default 0.0'
            )
        ] = 0.0,
        window: Annotated[
            int,
        ...
        adjusted: Annotated[
            ...
            OpenBBField(
                description=(
                    'Adjust sortino ratio to compare it to sharpe'
        ...
        index: Annotated[
            str,
            OpenBBField(
                description='Index column for input data'
            )
        ] = 'date',
        **kwargs: Any
    ) -> OBBject:
