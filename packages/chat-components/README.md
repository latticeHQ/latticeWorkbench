...
**Principle:** this package re-exports Lattice’s existing chat renderer implementation (messages, tools, markdown, diff rendering) to avoid a parallel rendering stack.
