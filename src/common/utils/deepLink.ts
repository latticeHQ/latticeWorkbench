...
/**
 * Parse a lattice:// deep link into a typed payload.
 *
 * Currently supported route:
 * - lattice://chat/new
 */
export function parseLatticeDeepLink(raw: string): LatticeDeepLinkPayload | null {
  let url: URL;
 ...
 *
 * Matching rules:
 * - Compare against the final path segment (e.g. /Users/me/repos/lattice -> "lattice")
