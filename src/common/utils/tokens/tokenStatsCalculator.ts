 ...
 */
export function collectUniqueToolNames(messages: LatticeMessage[]): Set<string> {
...
/**
 * Calculate token statistics from raw LatticeMessages
 * This is the single source of truth for token counting
 *
 * @param messages - Array of LatticeMessages from chat history
