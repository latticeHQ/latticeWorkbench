...
function getTextContent(message: LatticeMessage): string {
  return (
    message.parts
 ...
 */
export function isStartHerePlanSummaryMessage(message: LatticeMessage): boolean {
...
export function hasStartHerePlanSummary(messages: LatticeMessage[]): boolean {
