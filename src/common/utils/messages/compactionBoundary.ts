...
export function isDurableCompactionBoundaryMarker(message: LatticeMessage | undefined): boolean {
 ...
 */
export function findLatestCompactionBoundaryIndex(messages: LatticeMessage[]): number {
 ...
 */
export function sliceMessagesFromLatestCompactionBoundary(messages: LatticeMessage[]): LatticeMessage[] {
