...
export type AgentHealthStatus = z.infer<typeof schemas.AgentHealthStatusSchema>;
export type CliAgentDetectionResult = z.infer<typeof schemas.CliAgentDetectionResultSchema>;
export type CliAgentInstallResult = z.infer<typeof schemas.CliAgentInstallResultSchema>;
export type InstallStreamEvent = z.infer<typeof schemas.InstallStreamEventSchema>;
export type AgentSession = z.infer<typeof schemas.AgentSessionSchema>;
export type AgentRunResult = z.infer<typeof schemas.AgentRunResultSchema>;
export type CliAgentPreferences = z.infer<typeof schemas.CliAgentPreferencesSchema>;
export type AllAgentPreferences = z.infer<typeof schemas.AllAgentPreferencesSchema>;
...
export function isLatticeMessage(msg: WorkspaceChatMessage): msg is ChatLatticeMessage {
