...
import { PluginPackDescriptorSchema, PluginPackMcpServerSchema, PluginPackNameSchema } from "./pluginPack";
import {
...
// - Project path: <projectPath>/.lattice/agents - shared across all workspaces
