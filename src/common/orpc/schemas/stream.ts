...
import { LatticeProviderOptionsSchema } from "./providerOptions";
...
export const StreamEndEventSchema = z.object({
  ...
  metadata: z
    ...
    .meta({
      description: "Structured metadata from backend - directly mergeable with LatticeMetadata",
    }),
...
// LatticeMessageSchema is used for persisted data (chat.jsonl) which doesn't have a type field.
// This wrapper adds a type discriminator for real-time streaming events.
export const ChatLatticeMessageSchema = LatticeMessageSchema.extend({
