...
export const LatticeTextPartSchema = z.object({
  type: z.literal("text"),
  text: z.string(),
  timestamp: z.number().optional(),
});

export const LatticeReasoningPartSchema = z.object({
...
const LatticeToolPartBase = z.object({
...
export const DynamicToolPartPendingSchema = LatticeToolPartBase.extend({
  state: z.literal("input-available"),
  nestedCalls: z.array(NestedToolCallSchema).optional(),
});

export const DynamicToolPartAvailableSchema = LatticeToolPartBase.extend({
...
export const LatticeToolPartSchema = DynamicToolPartSchema;

export const LatticeFilePartSchema = FilePartSchema.extend({
  type: z.literal("file"),
});
