...
type ModelProvider = "anthropic" | "openai" | "google" | "xai" | "claude-code";
...
const MODEL_DEFINITIONS = {
  ...
  // Claude Code subprocess models — route through the real `claude` CLI binary
  // so Pro/Max subscription billing works instead of API key billing.
  CC_OPUS: {
    provider: "claude-code",
    providerModelId: "claude-opus-4-6",
    aliases: ["cc:opus"],
    // Reuse anthropic tokenizer for approximate counting
    tokenizerOverride: "anthropic/claude-sonnet-4.5",
  },
  CC_SONNET: {
    provider: "claude-code",
