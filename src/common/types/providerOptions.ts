...
import type { LatticeProviderOptionsSchema } from "../orpc/schemas";

/**
 * Lattice provider-specific options that get passed through the stack.
...
export type LatticeProviderOptions = z.infer<typeof LatticeProviderOptionsSchema>;
