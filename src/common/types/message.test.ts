...
describe("buildContinueMessage", () => {
  ...
  test("preserves latticeMetadata when provided", () => {
    ...
    expect(result?.latticeMetadata).toEqual(latticeMetadata);
  });
...
describe("rebuildContinueMessage", () => {
  ...
  test("preserves latticeMetadata from persisted data", () => {
    const latticeMetadata = {
      type: "agent-skill",
      rawCommand: "/test-skill hello",
      skillName: "test-skill",
