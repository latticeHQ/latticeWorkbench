 ...
 *   Lattice intercepts tool calls and manages execution. The AI SDK's
 *   streamText() handles the multi-step tool loop — each doStream() call
 *   spawns a fresh process and writes the full conversation to stdin.
 */
