...
import type { LatticeReasoningPart, LatticeTextPart, LatticeToolPart } from "./message";
import type {
 ...
 */
export type CompletedMessagePart = LatticeReasoningPart | LatticeTextPart | LatticeToolPart;
