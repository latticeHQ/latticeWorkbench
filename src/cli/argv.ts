 ...
 * - Packaged Electron app (./lattice.AppImage)
 */
...
export function isElectronLaunchArg(
  ...
  if (subcommand?.startsWith("lattice://") === true) return true;
...
export function isCommandAvailable(
  ...
  if (command === "desktop") {
    ...
    // When run via node/bun (npx lattice), require("../desktop/main") fails because
