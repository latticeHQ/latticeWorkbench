...
/**
 * Resolve the auth token for `lattice server` from CLI flags, env vars, or generate one.
 *
 * Precedence: --no-auth > --auth-token > LATTICE_SERVER_AUTH_TOKEN > auto-generated.
 */
