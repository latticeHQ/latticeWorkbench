...
// test execution. Run these locally with LATTICE_TEST_TIMING=1 when you want to
// sanity-check constant-time behavior.
const describeTiming = process.env.LATTICE_TEST_TIMING === "1" ? describe : describe.skip;
