 ...
 *
 * Multiple OAuth services (Governor, Codex, MCP) spin up a local HTTP
 * server to receive the authorization code redirect. The pattern is identical
 * across all of them — this module extracts that into a single reusable utility.
 */
 ...
 *
 * Pattern extracted from the `http.createServer` blocks in Governor,
