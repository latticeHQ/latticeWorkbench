...
describe("buildSystemMessage", () => {
  ...
  beforeEach(async () => {
    // Snapshot any existing LATTICE_ROOT so we can restore it after the test.
    ...
    // Force lattice home to our test .lattice directory regardless of host LATTICE_ROOT.
    process.env.LATTICE_ROOT = globalDir;
