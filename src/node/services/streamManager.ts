...
export class StreamManager extends EventEmitter {
   ...
   * Use ~/.lattice-tmp instead of system temp directory (e.g., /var/folders/...)
  ...
  public async createTempDirForStream(streamToken: StreamToken, runtime: Runtime): Promise<string> {
    const tempDir = `~/.lattice-tmp/${streamToken}`;
  ...
  private getStreamMode(initialMetadata?: Partial<LatticeMetadata>): "plan" | "exec" | undefined {
