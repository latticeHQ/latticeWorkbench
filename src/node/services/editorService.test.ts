...
describe("EditorService", () => {
  ...
  test("validates custom editor executable exists before spawning", async () => {
    const minion: FrontendMinionMetadata = {
      id: "ws1",
      name: "ws1",
      projectName: "proj",
      ...
      namedMinionPath: "/tmp/src/proj/ws1",
    };

    const mockConfig: Pick<Config, "getAllMinionMetadata"> = {
      getAllMinionMetadata: () => Promise.resolve([minion]),
    } as unknown as Pick<Config, "getAllMinionMetadata">;
