...
/**
 * Safe fallback cwd for runtime.exec() calls that don't need a specific minion cwd.
 *
...
export const BG_OUTPUT_SUBDIR = "lattice-bashes";
 ...
 * @param bgOutputDir Base directory (e.g., /tmp/lattice-bashes or ~/.lattice/sessions)
...
export function computeOutputPaths(
  ...
  const outputDir = `${bgOutputDir}/${minionId}/${processId}`;
  return {
    outputDir,
...
export interface SpawnOptions {
  ...
  cwd: string;
  /** Minion ID for output directory organization */
  minionId: string;
