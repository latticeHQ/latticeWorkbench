...
describe("UpdaterService", () => {
  ...
  describe("transient error backoff", () => {
    const missingNightlyManifestError =
      'Cannot find latest-mac.yml in the latest release artifacts (https://github.com/latticeHQ/latticeWorkbench/releases/download/v0.18.1-nightly.16/latest-mac.yml): HttpError: 404 "method: GET url: https://github.com/latticeHQ/latticeWorkbench/releases/download/v0.18.1-nightly.16/latest-mac.yml\n\nPlease double check that your authentication token is correct.\n" Headers: { ... }\n    at createHttpError (/path/httpExecutor.ts:31:10)';
