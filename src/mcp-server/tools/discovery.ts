...
const CATEGORIES: Record<string, string> = {
  ...
  browser: "[Minion-scoped] Headless browser via agent-browser: navigate, snapshot (accessibility tree with refs), screenshot, annotated screenshot, click, fill, type, press, hover, scroll, find (semantic locators), wait, eval (JS), viewport/device emulation, tabs, dialogs, cookies, network requests, drag, select. Live WebSocket streaming for interactive use. Each minion gets its own isolated browser. Parent: minion.",
