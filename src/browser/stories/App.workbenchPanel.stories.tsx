/**
 * WorkbenchPanel tab stories - testing dynamic tab data display
 *
...
export const CostsTab: AppStory = {
  render: () => (
    <AppWithMocks
      setup={() => {
        ...
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "400");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-costs"));

        const client = setupSimpleChatStory({
          minionId: "ws-costs",
          minionName: "feature/api",
          projectName: "my-app",
          messages: [
  ...
  play: async ({ canvasElement }) => {
    ...
    // Session usage is fetched async via MinionStore; wait to avoid snapshot races.
    await waitFor(() => {
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("costs"));
        localStorage.setItem("costsTab:viewMode", JSON.stringify("session"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "350");
        const modelUsage = {
        ...
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-cache-create"));

        const client = setupSimpleChatStory({
          minionId: "ws-cache-create",
          minionName: "feature/caching",
          projectName: "my-app",
          messages: [
...
export const ReviewTab: AppStory = {
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("costs"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "700");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-review"));

        const client = setupSimpleChatStory({
          minionId: "ws-review",
          minionName: "feature/review",
          projectName: "my-app",
          messages: [
...
/**
 * Explorer tab showing minion file tree with folders and files
 */
export const ExplorerTab: AppStory = {
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("explorer"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "350");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-explorer"));

        const client = setupSimpleChatStory({
          minionId: "ws-explorer",
          minionName: "feature/files",
          projectName: "my-app",
          messages: [
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("explorer"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "350");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-explorer-expanded"));

        const client = setupSimpleChatStory({
          minionId: "ws-explorer-expanded",
          minionName: "feature/files",
          projectName: "my-app",
          messages: [
            createUserMessage("msg-1", "Show me the project structure", { historySequence: 1 }),
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("explorer"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "350");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-explorer-selected"));

        const client = setupSimpleChatStory({
          minionId: "ws-explorer-selected",
          minionName: "feature/files",
          projectName: "my-app",
          messages: [
            createUserMessage("msg-1", "Show me the project structure", { historySequence: 1 }),
...
export const StatsTabIdle: AppStory = {
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("stats"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "400");
        // Clear persisted layout to ensure stats tab appears in fresh default layout
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-stats-idle"));

        const client = setupSimpleChatStory({
          minionId: "ws-stats-idle",
          minionName: "feature/stats",
          projectName: "my-app",
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        ...
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "400");
        // Clear persisted layout to ensure stats tab appears in fresh default layout
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-stats-streaming"));

        const client = setupStreamingChatStory({
          minionId: "ws-stats-streaming",
          minionName: "feature/streaming",
          projectName: "my-app",
          statsTabEnabled: true,
          messages: [
...
export const ReviewTabSortByLastEdit: AppStory = {
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("review"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "700");
        // Clear persisted layout to ensure review tab appears in fresh default layout
        const minionId = "ws-review-sort";
        localStorage.removeItem(getWorkbenchPanelLayoutKey(minionId));
        const now = Date.now();
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("review"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "700");
        const minionId = "ws-review-file-order";
        localStorage.removeItem(getWorkbenchPanelLayoutKey(minionId));
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("review"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "700");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-diff-alignment"));

        const client = setupSimpleChatStory({
          minionId: "ws-diff-alignment",
          minionName: "feature/alignment-test",
          projectName: "my-app",
          messages: [
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("review"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "700");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-diff-modification"));

        const client = setupSimpleChatStory({
          minionId: "ws-diff-modification",
          minionName: "feature/config-update",
          projectName: "my-app",
          messages: [
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("review"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "700");
        const minionId = "ws-read-more";
        localStorage.removeItem(getWorkbenchPanelLayoutKey(minionId));

        const client = setupSimpleChatStory({
          minionId,
          minionName: "feature/button-types",
          projectName: "my-app",
          messages: [
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("review"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "700");
        const minionId = "ws-read-more-boundaries";
        localStorage.removeItem(getWorkbenchPanelLayoutKey(minionId));

        const client = setupSimpleChatStory({
          minionId,
          minionName: "feature/math-utils",
          projectName: "my-app",
          messages: [
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("review"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "700");
        const minionId = "ws-untracked";
        localStorage.removeItem(getWorkbenchPanelLayoutKey(minionId));

        const client = setupSimpleChatStory({
          minionId,
          minionName: "feature/new-feature",
          projectName: "my-app",
          messages: [
...
export const ManyTabsWrap: AppStory = {
  render: () => (
    <AppWithMocks
      setup={() => {
        const minionId = "ws-many-tabs";
        updatePersistedState(WORKBENCH_PANEL_WIDTH_KEY, 280);
        updatePersistedState(getWorkbenchPanelLayoutKey(minionId), {
          version: 1,
          nextId: 2,
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        ...
        localStorage.setItem("costsTab:viewMode", JSON.stringify("session"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "400");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-compact-warning"));
        ...
        const client = setupSimpleChatStory({
          minionId: "ws-compact-warning",
          minionName: "feature/compaction",
          projectName: "my-app",
          messages: [
...
export const OutputTabEmpty: AppStory = {
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("output"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "400");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-output-empty"));
        localStorage.removeItem("output-tab-level");

        const client = setupSimpleChatStory({
          minionId: "ws-output-empty",
          minionName: "feature/logging",
          projectName: "my-app",
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("output"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "400");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-output-logs"));
        localStorage.removeItem("output-tab-level");

        const client = setupSimpleChatStory({
          minionId: "ws-output-logs",
          minionName: "feature/logging",
          projectName: "my-app",
  ...
  render: () => (
    <AppWithMocks
      setup={() => {
        localStorage.setItem(WORKBENCH_PANEL_TAB_KEY, JSON.stringify("output"));
        localStorage.setItem(WORKBENCH_PANEL_WIDTH_KEY, "400");
        localStorage.removeItem(getWorkbenchPanelLayoutKey("ws-output-errors"));
