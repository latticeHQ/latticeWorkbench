...
import { ProviderCacheHitChart } from "../../analytics/ProviderCacheHitChart";
import { ModelBreakdown } from "../../analytics/ModelBreakdown";
import { SpendChart } from "../../analytics/SpendChart";
import { SummaryCards } from "../../analytics/SummaryCards";
import { TimingChart } from "../../analytics/TimingChart";
import { formatProjectDisplayName } from "../../analytics/analyticsUtils";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-2">
        <label className="text-muted text-[11px]" htmlFor="analytics-project-filter">
          Project
        </label>
        <select
          ...
          className="border-border-medium bg-separator text-foreground h-5 rounded border px-1.5 text-[11px]"
        >
        ...
        <div className="border-border-medium bg-background flex items-center gap-0.5 rounded border px-0.5 py-0.5">
          {(
            [
              ["7d", "7D"],
              ["30d", "30D"],
