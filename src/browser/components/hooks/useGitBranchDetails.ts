...
const SECTION_MARKERS = {
  showBranchStart: "__LATTICE_BRANCH_DATA__BEGIN_SHOW_BRANCH__",
  showBranchEnd: "__LATTICE_BRANCH_DATA__END_SHOW_BRANCH__",
  datesStart: "__LATTICE_BRANCH_DATA__BEGIN_DATES__",
  datesEnd: "__LATTICE_BRANCH_DATA__END_DATES__",
  dirtyStart: "__LATTICE_BRANCH_DATA__BEGIN_DIRTY_FILES__",
  dirtyEnd: "__LATTICE_BRANCH_DATA__END_DIRTY_FILES__",
} as const;
...
printf '__LATTICE_BRANCH_DATA__BEGIN_SHOW_BRANCH__\\n%s\\n__LATTICE_BRANCH_DATA__END_SHOW_BRANCH__\\n' "$SHOW_BRANCH"
printf '__LATTICE_BRANCH_DATA__BEGIN_DATES__\\n%s\\n__LATTICE_BRANCH_DATA__END_DATES__\\n' "$DATES_OUTPUT"
