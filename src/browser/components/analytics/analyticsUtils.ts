...
// Each color is a distinct hue for clear visual differentiation.
export const ANALYTICS_CHART_COLORS = [
  "var(--color-accent)",        // orange — primary brand
  "var(--color-ask-mode)",      // blue — clear sky
  "var(--color-exec-mode)",     // teal — execution
  "var(--color-plan-mode)",     // violet — architecture
  "var(--color-edit-mode)",     // amber — editing
  "var(--color-task-mode)",     // emerald — parallel work
  "var(--color-debug-mode)",    // rose — debugging
  "var(--color-thinking-mode)", // indigo — thinking
] as const;
