...
interface ProjectCreateFormProps {
  ...
  /** Optional override for the submit button label (default: "Add HQ"). */
  submitLabel?: string;
  ...
  function ProjectCreateForm(
    ...
    const handleSelect = useCallback(async (): Promise<boolean> => {
      ...
      try {
        ...
        // Backend handles path resolution (bare names → ~/.lattice/projects/name)
...
/**
 * Headquarter creation modal that handles the full flow from path input to backend validation.
 *
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent showCloseButton={false}>
        <DialogHeader>
          <DialogTitle>Add Headquarters (HQ)</DialogTitle>
          <DialogDescription>Enter the path to your repository</DialogDescription>
        </DialogHeader>
