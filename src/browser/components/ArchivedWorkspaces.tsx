      ...
      <div className="border-border rounded-lg border">
        ...
        <div className="flex items-center gap-2 px-4 py-3">
          <button
            ...
            aria-label={isExpanded ? "Collapse archived missions" : "Expand archived missions"}
              ...
              <div className="border-border flex items-center gap-2 border-b px-4 py-2">
                ...
                {workspaces.length > 3 && (
                  <div className="relative flex-1">
                    ...
                    <input
                      type="text"
                      placeholder="Search archived missions or branches..."
                      value={searchQuery}
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <button
                                  ...
                                  aria-label={`Restore mission ${displayTitle}`}
                                >
                                  <ArchiveRestoreIcon className="h-4 w-4" />
                                </button>
                              </TooltipTrigger>
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <button
                                  ...
                                  aria-label={`Delete mission ${displayTitle}`}
                                >
                                  {isProcessing ? (
