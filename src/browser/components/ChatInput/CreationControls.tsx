...
interface CreationControlsProps {
  ...
  disabled: boolean;
  /** Headquarter path to display (and used for project selector) */
  projectPath: string;
  /** Headquarter name to display as header */
  projectName: string;
...
/** Headquarter picker dropdown matching Claude Code reference style */
    ...
    >
      ...
      <SelectContent>
        {runtimeOptions.map((option) => {
          ...
          return (
            <SelectItem key={option.value} value={option.value} disabled={isModeDisabled}>
              {option.label}
            </SelectItem>
          );
        })}
