...
import { BaseSelectorPopover } from "./WorkbenchPanel/CodeReview/BaseSelectorPopover";

// Helper for indicator colors — distinct hues per branch
const getIndicatorColor = (branch: number): string => {
  switch (branch) {
    case 0:
      return "#60A5FA"; // Blue for HEAD
    case 1:
      return "#A78BFA"; // Violet for origin/main
    case 2:
      return "#2DD4BF"; // Teal for origin/branch
    default:
