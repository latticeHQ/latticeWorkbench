    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent maxWidth="600px" maxHeight="80vh" showCloseButton={false}>
        <DialogHeader>
          ...
          <DialogDescription>Headquarter: {projectName}</DialogDescription>
        </DialogHeader>
        <DialogInfo>
          <p>
            Secrets are stored in <code>~/.lattice/secrets.json</code> (kept away from source code)
            but namespaced per project.
          </p>
