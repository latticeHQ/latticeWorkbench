...
describe("API reconnection", () => {
  beforeEach(() => {
    ...
    const happyWindow = new GlobalWindow({ url: "https://lattice.example.com/" });
  ...
  test("constructs WebSocket URL with app proxy prefix", () => {
    window.location.href = "https://lattice.example.com/@u/ws/apps/lattice/?token=abc";
    ...
    expect(ws1!.url).toBe("wss://lattice.example.com/@u/ws/apps/lattice/orpc/ws?token=abc");
  });
