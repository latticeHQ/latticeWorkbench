 ...
 *
 * When Lattice is served behind a path-based app proxy (e.g. Lattice with subdomain=false),
 * the app is mounted under a prefix like:
 *
 *   /@user/<minion>/apps/<slug>
 *
 ...
 *
 * Examples:
 * - "/@u/ws/apps/lattice/" -> "/@u/ws/apps/lattice"
 * - "/@u/ws/apps/lattice/settings" -> "/@u/ws/apps/lattice"
 */
 ...
 *   Lattice-style app proxy base path.
 *
